        ...
        <template slot="page-body">
            <div class="info-holder" style="height:45%">
                <div class="profile-header flex-container" style="height: 100%">
                    ...
                    <span class="profile-2half"><div id="profile-photo" :style="'background-image:url('+this.datosprofile.photo+')'"></div>
                        <div id="popularity" style="height: 100%"><div id="subsHolder"><button @click="changeSubButton" id="subscrito" >{{this.subscribirse}}</button></div><span style="margin-left:18%;background-color: #99999924;border-radius:10%"> Subs:{{this.datosprofile.subscriptores}}</span></div>
                    </span>

                </div>
            </div>
            <div  id="reviews" >
                <div style="text-decoration-line: underline;color:#adadad" @click="$refs['modal-add-reseña-profile'].open()"><a style="font-size: smaller;">Agregar reseña</a></div>
            ...
            <modal-two  ref="modal-add-reseña-profile" title="Crear reseña">
                <div class="container">
                    <div style=" width:100%;height:50px"><input style=" width:70%;background-color: rgba(194,194,194,0.61);border-radius: 2%" v-model="reseña"></input></div>
                    <div><button @click="mandarResena">Mandar</button></div>
                </div>
